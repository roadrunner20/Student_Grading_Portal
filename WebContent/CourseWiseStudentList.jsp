...
<title>Course Wise Student List</title>
</head>
<body>
<div class="main">
<div class="page-out">
...
<%
	...
	try
	{
		...
		if(rs.next())
		{
			...
			{
				String Query="select CourseName, StudentCourseDetails.CourseId, RollNumber, FirstName, LastName from CourseDetails, StudentCourseDetails, StudentLogin where StudentCourseDetails.CourseId = CourseDetails.CourseId and StudentCourseDetails.RollNumber = StudentLogin.LoginId order by CourseName;";
				ps = con.prepareStatement(Query);
				rs = ps.executeQuery();
				%>
				<b>Course Wise Student List</b>
				<br><br>
				<table border="">
				<tr>
				<th>No</th>
			...
			{
				out.println("your Login Id don't match to databases");
			}
		}
		else
		{
