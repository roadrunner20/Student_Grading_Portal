...
try
{
	String sqlOption="select * from StudentLogin where LoginId='"+LoginId+"'";
	...
	if(rsDoLogin.next())
	{
		...
		session.setAttribute("FirstName",rsDoLogin.getString("FirstName"));
		session.setAttribute("LoginId",rsDoLogin.getString("LoginId"));
		...
		response.sendRedirect("StudentHome.jsp?error="+message);
		//out.println("welcome "+LoginId);
	}
    else
    {
    	message="No user or password matched" ;
    	response.sendRedirect("StudentLogin.jsp?error="+message);
    }
}
catch(Exception e)
{
