...
<head>
<title>Student Wise Record</title>
...
<title>Student wise Academic Record</title>
</head>
<body>
<div class="main">
<div class="page-out">
...
<%
	...
	try
	{
		...
		if(rs.next())
		{
			...
			{
				String Query=" select RollNumber, FirstName, LastName , CourseName ,Credit, Quiz1, Quiz2, Quiz3, MidSemMarks, EndSemMarks,Total, Grade from CourseDetails,StudentPerformance , StudentLogin where StudentPerformance.RollNumber = StudentLogin.LoginId and StudentPerformance.CourseId = CourseDetails.CourseId order by RollNumber;";
				ps = con.prepareStatement(Query);
				rs = ps.executeQuery();
				%>
				<b>Student wise Academic Record</b>
				<br><br>
				<table border="">
				<tr>
				<th>No</th>
