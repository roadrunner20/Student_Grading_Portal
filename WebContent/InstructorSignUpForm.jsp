...
<p><h1>New Account Form</h1>
<div><%=SignUpMsg %></div>
<form name="FormSignUp" onSubmit="return validate();" action="InstructorSignUp.jsp" method="post">
<table>
<tr>
<td> Faculty Id:</td><td><input type="text" name="LoginId" size=20><br></td>
</tr>
<tr>
...
<tr>
<td> Room Number:</td><td><input type="text" name="RoomNumber" size=20><br></td>
</tr>
<tr>
<td> Email Id:</td><td><input type="email" name="EmailId" size=20><br></td>
</tr>
<tr>
<td> Phone Number:</td><td><input type="text" name="PhoneNumber" size=20>(Without any code)<br></td>
</tr><br><br>
<tr>
